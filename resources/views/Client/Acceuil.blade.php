        ...
        <div class="col-9">
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                            <a type="submit" class="btn btn-primary" href="{{ route('creat',['id'=>$client['id']]) }}">ajouter</a>
                    </div>
                 </div>
            </div>
            <table class="table">
        ...
        <div class="col-3">
            <div class="card text-bg-primary mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Prenom: {{$client['Prenom']}}</p>
                  <p class="card-text">telephone: {{$client['mail']}}</p>
